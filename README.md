...
## Usage
Copy templates to your Obsidian template folder location to make them available as templates within Obsidian. More about: [Obsidian Help - Templates](https://help.obsidian.md/Plugins/Templates)
...
1. [Bases](https://obsidian.md/help/bases) - Lets you create database-like views of your notes. Used to view, edit, sort, and filter files and their properties.
